...
- (void)initialize
{
	...
	_bnMinus = [[UIButton buttonWithType:UIButtonTypeCustom] retain];
	...
	_bnPlus = [[UIButton buttonWithType:UIButtonTypeCustom] retain];
...
+ (UIImage*)imagePlus64
{
	...
	if(!_imagePlus64)
	{
		...
		_imagePlus64 = [[UIImage imageWithData:data] retain];
	}
	return _imagePlus64;
}
...
+ (UIImage*)imageMinus64
{
	...
	if(!_imageMinus64)
	{
		...
		_imageMinus64 = [[UIImage imageWithData:data] retain];
	}
