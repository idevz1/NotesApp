...
- (GDataXMLElement *)firstElementForName:(NSString *)name {
	NSArray *elems = [self elementsForName:name];
	if(!elems || !elems.count)
		return nil;
	return [elems objectAtIndex:0];
}
...
- (NSString *)stringValueOfAttributeForName:(NSString *)name defaultValue:(NSString*)defaultValue {
