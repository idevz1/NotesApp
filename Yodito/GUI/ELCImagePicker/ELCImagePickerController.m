...
- (id)initWithSelectDefultGroupOnShow:(BOOL)selectDefultGroupOnShow {
...
- (id)init
{
	...
	self = [super init];
    if (self) {
		ELCAlbumPickerController *albumPicker = [[[ELCAlbumPickerController alloc] initWithStyle:UITableViewStylePlain] autorelease];
