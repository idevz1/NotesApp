...
- (id)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier
{
	...
	if (self) {
        ...
        NSMutableArray *overlayArray = [[[NSMutableArray alloc] initWithCapacity:4] autorelease];
...
- (void)setAssets:(NSArray *)assets
{
    ...
    for (int i = 0; i < [_rowAssets count]; ++i) {
        ...
        if (i < [_imageViewArray count]) {
            ...
            UIImageView *imageView = [[[UIImageView alloc] initWithImage:[UIImage imageWithCGImage:asset.asset.thumbnail]] autorelease];
